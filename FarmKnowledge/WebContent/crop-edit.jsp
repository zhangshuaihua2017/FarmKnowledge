...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form" action="javascript:updateCrop()">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="${crop.img1}">
                    </div>
                    <div class="layui-form-mid layui-word-aux">
                    	*img1地址
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="${crop.img2}">
                    </div>
                    <div class="layui-form-mid layui-word-aux">
                    	*img2地址
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="${crop.img3}">
                    </div>
                    <div class="layui-form-mid layui-word-aux">
                    	*img3地址
                    </div>
